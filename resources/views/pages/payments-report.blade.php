                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <form id="filter-report" method="GET" action="{{ route('payments-report') }}" class="d-flex">
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($payments as $payment)
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{ number_format($payment->vehicle->balance, 2) }}</td>
